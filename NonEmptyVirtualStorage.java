...
public class NonEmptyVirtualStorage implements BitmapStorage {
   ...
   * thrown.
   * 
   * @see hybridewah.BitmapStorage#add(long)
   */
   ...
   * 
   * @see hybridewah.BitmapStorage#addStreamOfLiteralWords(long[], long, long)
   */
   ...
   * 
   * @see hybridewah.BitmapStorage#addStreamOfEmptyWords(boolean, long)
   */
   ...
   * throws a NonEmptyException exception when number > 0
   * 
   * @see hybridewah.BitmapStorage#addStreamOfNegatedLiteralWords(long[], long,
   *      long)
   */
   ...
   * Does nothing.
   * 
   * @see hybridewah.BitmapStorage#setSizeInBits(int)
   */
